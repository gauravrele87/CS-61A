...
class Expr:
    ...
    In our code, the four types of expressions are subclasses of the2 `Expr`
...
class Name(Expr):
    ...
    def eval(self, env):
        ...
        try:
            ...
            raise NameError('{0} not found'.format(self.string))
...
class LambdaFunction(Value):
    ...
    def apply(self, arguments):
        ...
        parent_copy.update({par: arg for par, arg in zip(self.parameters, arguments)})

...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    arr = [int(s) for s in str(score)]
    return (2 + abs(arr[0] - arr[1])) if len(arr)>1 else (2+arr[0])
    # END PROBLEM 2
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    return free_bacon(opponent_score) if num_rolls == 0 else roll_dice(num_rolls,dice = dice)
    # END PROBLEM 3
...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    return True if score0>1 and score1>1 and (score0%score1 == 0 or score1%score0 == 0) else False
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def announce(score0, score1):
        ...
        if change > previous_high and change == 1:
            print("{0} point! That's the biggest gain yet for Player {1}".format(change,who))
            high = change
        elif change > previous_high and change != 1:
            print("{0} points! That's the biggest gain yet for Player {1}".format(change,who))
            high = change
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    avg = [make_averaged(roll_dice,num_samples)(i,dice) for i in range(1,11)]
    return avg.index(max(avg))+1 
    # END PROBLEM 9
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score > opponent_score:
        if score > 80:
            ...
            return swap_strategy(score,opponent_score,5,7)
    return 6
    # END PROBLEM 12

...
class MissManners:
    ...
    'Current balance: $10'
    """
    # The last double fussy doc test is confusing and I couldnt make it work 
    # because i couldnt understand why you need one message and 2 args for it
    ...
    def ask(self, message, *args):
        ...
        if not message.startswith(magic_word):
            ...
            if hasattr(self.obj, message):
                return getattr(self.obj, msg[1])(*args)
            else:
                return 'Thanks for asking, but I know not how to {0}.'.format(' '.join(msg[1:]))
        elif message == 'please vend':
            return getattr(self.obj, 'vend')()
        elif message == 'please deposit':
